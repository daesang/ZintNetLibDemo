...
namespace ZintNetLibTest
{
    public partial class Form1 : Form
    {
        ...
        private int hanxinErrorLevel = 0;
        ...
        private void SetBarcodeProperties()
        {
            ...
            myBarcode.Multiplier = multiplierValue; //크기
            ...
            if (symbolID == Symbology.QRCode || symbolID == Symbology.MicroQRCode)
            {
                ...
                myBarcode.QRCodeErrorLevel = qrErrorLevel;
            }
            ...
            if (symbolID == Symbology.PDF417 || symbolID == Symbology.PDF417Truncated)
            {
                ...
                myBarcode.PDF417ErrorLevel = pdfErrorLevelComboBox.SelectedIndex - 1;
            ...
            if(symbolID == Symbology.ChannelCode)
                myBarcode.ChannelCodeLevel = columnsComboBox.SelectedIndex;
            ...
            if (myBarcode != null && !String.IsNullOrEmpty(barcodeData))
            {
                try
                {
                    ...
                    for (int i = 0; i < 1000; i++)
                    {
                        ...
                        using (Bitmap bitmap = new Bitmap(1000, 1000)) //너무 높으면 속도 느림.
                    ...
                    SaveToImage("gwise.png", ImageFormat.Png);
                }
